...
export const SQUAD: Array<{ unit: UnitName; players: Player[] }> = [
  {
    unit: "Goalkeepers",
    players: [
      { num: 1,  name: "Angus Gunn",         club: "Nottingham Forest",   clubKey: "forest" },
      { num: 12, name: "Liam Kelly",         club: "Rangers",             clubKey: "rangers" },
      { num: 21, name: "Craig Gordon",       club: "Heart of Midlothian", clubKey: "hearts" },
    ],
  },
  {
    unit: "Defenders",
    players: [
      { num: 3,  name: "Andy Robertson",     club: "Tottenham Hotspur",   clubKey: "spurs", captain: true },
      { num: 2,  name: "Aaron Hickey",       club: "Brentford",           clubKey: "brentford" },
      { num: 5,  name: "Grant Hanley",       club: "Hibernian",           clubKey: "hibs" },
      { num: 6,  name: "Kieran Tierney",     club: "Celtic",              clubKey: "celtic" },
      { num: 13, name: "Jack Hendry",        club: "Al-Ettifaq",          clubKey: "ettifaq" },
      { num: 15, name: "John Souttar",       club: "Rangers",             clubKey: "rangers" },
      { num: 16, name: "Dominic Hyam",       club: "Wrexham",             clubKey: "wrexham" },
      { num: 22, name: "Nathan Patterson",   club: "Everton",             clubKey: "everton" },
      { num: 24, name: "Anthony Ralston",    club: "Celtic",              clubKey: "celtic" },
      { num: 26, name: "Scott McKenna",      club: "Dinamo Zagreb",       clubKey: "dinamo" },
    ],
  },
  {
    unit: "Midfielders",
    players: [
      { num: 4,  name: "Scott McTominay",    club: "Napoli",              clubKey: "napoli" },
      { num: 7,  name: "John McGinn",        club: "Aston Villa",         clubKey: "villa" },
      { num: 8,  name: "Tyler Fletcher",     club: "Manchester United",   clubKey: "manutd" },
      { num: 11, name: "Ryan Christie",      club: "Bournemouth",         clubKey: "bournemouth" },
      { num: 17, name: "Ben Gannon-Doak",    club: "Bournemouth",         clubKey: "bournemouth" },
      { num: 19, name: "Lewis Ferguson",     club: "Bologna",             clubKey: "bologna" },
      { num: 23, name: "Kenny McLean",       club: "Norwich City",        clubKey: "norwich" },
      { num: 25, name: "Findlay Curtis",     club: "Kilmarnock",          clubKey: "kilmarnock" },
    ],
  },
  {
    unit: "Forwards",
    players: [
      { num: 9,  name: "Lyndon Dykes",       club: "Charlton Athletic",   clubKey: "charlton" },
      { num: 10, name: "Che Adams",          club: "Torino",              clubKey: "torino" },
      { num: 14, name: "Ross Stewart",       club: "Southampton",         clubKey: "soton" },
      { num: 18, name: "George Hirst",       club: "Ipswich Town",        clubKey: "ipswich" },
      { num: 20, name: "Lawrence Shankland", club: "Rangers",             clubKey: "rangers" },
    ],
  },
];
